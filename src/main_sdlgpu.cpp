...
int main(int, char**)
{
    fmt::print("Starting Dear ImGui + SDL3 GPU example...\n");

    fmt::print("now running sol3 mini sample\n");
    mini_sol3_example();
    ...
    {
        const char* driver_name = SDL_GetGPUDeviceDriver(gpu_device);
        SDL_Log("SDL_GPU initialized using backend: %s", driver_name);
    }
